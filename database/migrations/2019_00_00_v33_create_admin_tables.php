...
class CreateAdminTables extends Migration
{
    ...
    public function importData()
    {
        DB::table('admin_menu')->insert([
            ...
            ['id' => 26, 'parent_id' => 5, 'sort' => 1, 'title' => 'lang::store_info.admin.title', 'icon' => 'fa-universal-access', 'uri' => 'admin::store_info', 'type' => 0],
            ['id' => 25, 'parent_id' => 5, 'sort' => 2, 'title' => 'lang::store_value.admin.title', 'icon' => 'fa-bluetooth-b', 'uri' => 'admin::store_value', 'type' => 0],
