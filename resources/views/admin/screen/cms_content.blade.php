                    ...
                    <div class="fields-group">
                        ...
                        <div
                            ...
                            <label for="{{ $code }}__title"
                                class="col-sm-2  control-label">{{ trans('Modules/Cms/Content.title') }}</label>
                            <div class="col-sm-8">
                        ...
                        <div
                            ...
                            <label for="{{ $code }}__keyword"
                                class="col-sm-2  control-label">{{ trans('Modules/Cms/Content.keyword') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                        ...
                        <div
                            ...
                            <label for="{{ $code }}__description"
                                class="col-sm-2  control-label">{{ trans('Modules/Cms/Content.description') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                        ...
                        <div class="form-group  {{ $errors->has('category_id') ? ' has-error' : '' }}">
                            <label for="category_id"
                                class="col-sm-2 asterisk control-label">{{ trans('Modules/Cms/Content.admin.select_category') }}</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group   {{ $errors->has('image') ? ' has-error' : '' }}">
                            <label for="image"
                                class="col-sm-2  control-label">{{ trans('Modules/Cms/Content.image') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                ...
                                <div id="preview_image" class="img_holder"><img
                                        src="{{ asset(old('image',$content['image']??'')) }}"></div>
                            </div>
                        </div>

                        <div class="form-group   {{ $errors->has('sort') ? ' has-error' : '' }}">
                            <label for="sort"
                                class="col-sm-2  control-label">{{ trans('Modules/Cms/Content.sort') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                        ...
                        <div class="form-group  ">
                            <label for="status"
                                class="col-sm-2  control-label">{{ trans('Modules/Cms/Content.status') }}</label>
                            <div class="col-sm-8">
